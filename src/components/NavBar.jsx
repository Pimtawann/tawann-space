...
export default function NavBar() {
    ...
    return(
        ...
        <div className="hidden md:flex gap-3 items-center">
            ...
            className="bg-white border border-black px-[40px] py-[12px] rounded-full font-medium hover:bg-[#dad6d1] hover:border-[#dad6d1] transition-colors duration-200">Log in</button>
            <button 
            onClick={() => navigate("signup")}
            className="bg-black text-white px-[40px] py-[12px] rounded-full font-medium hover:bg-[#dad6d1] hover:text-black transition-colors duration-200">Sign up</button>
        </div>
        ...
        <div className="absolute top-full w-full left-0 flex flex-col items-center gap-7 px-4 py-12 border-b bg-[#f9f8f6] border-gray-300 md:hidden ">
            <button 
            onClick={() => navigate("/login")}
            className="w-full bg-white border border-black py-3 rounded-full text-lg font-medium mx-auto">Log in</button>
            <button 
            onClick={() => navigate("signup")}
            className="w-full bg-[#26231e] text-white py-3 rounded-full text-lg font-medium mx-auto">Sign up</button>
        </div>
        )}
        </nav>
    )
